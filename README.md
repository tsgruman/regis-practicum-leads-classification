...
# Discussion
With just 6 of the 126 variables (i.e. time on website, asymmetrique activity score, occupation of working professional, people looking for better career prospects, lead profile of potential lead, and lead origin of lead add form), I was able to get prediction models with over 80% accuracy. Predicting lead conversion is fairly low stakes, so I feel confident using the tuned XGBoost model to predict outcomes. With these results, X Education could focus their sales and marketing efforts on working professionals who are looking for better career prospects, as well as improving web features to try to maximize a lead's total time spent on their website.
